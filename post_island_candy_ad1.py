"""Post Island Candy Ad #2 — Sweet Reward (run immediately as test)"""
import sys, os, time
...
IMAGE_PATH = r"C:\Users\mario\island_candy_ad_images\ad_2_sweet_reward.png"

MESSAGE = """You earned this. \U0001f366

Beat the high score. Grab the prize. Now go get your ice cream.

\U0001f3ae Games + \U0001f36c Sweets = the perfect SPI combo
\U0001f368 Homemade ice cream starting at $3.99
\U0001f3af Located inside Island Arcade \u2014 2311 Padre Blvd

The sweetest reward on South Padre Island is one scoop away.

#IslandCandy #IslandArcade #SouthPadreIsland"""
...
with sync_playwright() as p:
    ...
    if posted:
        print("\n[SUCCESS] Island Candy Ad #2 (Sweet Reward) posted!")
    else:
