#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""gbp_post_island_candy.py — Post ad_3_homemade_icecream to Island Candy GBP (Yehuda account)"""
...
IMAGE = "C:/Users/mario/island_candy_ad_images/ad_3_homemade_icecream.png"
TEXT = (
...
async def post():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.wait_for_timeout(4000)
            await page.screenshot(path=str(SCRIPT_DIR / "gbp_ic_step5_final.png"), full_page=True)
