#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Serve the combined 6-post preview from already-generated images."""

import base64, http.server, os, sys, threading, webbrowser
...
def build_card(ad, idx):
    ...
    img_tag = (f'<img src="data:image/png;base64,{b64}" style="width:100%;display:block;">'
               if b64 else
               '<div style="height:260px;background:#ddd;display:flex;align-items:center;justify-content:center;color:#888;font-size:13px;">Image file not found</div>')
    copy_html = (ad["copy"]
...
if __name__ == "__main__":
    print(f"[BUILD] Page ready ({len(HTML_CONTENT)//1024}KB)")
